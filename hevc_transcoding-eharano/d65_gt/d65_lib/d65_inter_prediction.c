...
#if SIMD
  const static sint16 ALIGNED(16) filterSimd[4][4][8] =
  {
    {
      {   0,   0,   0,   0,   0,   0,   0,   0 },
      {   0,  64,   0,  64,   0,  64,   0,  64 },
                         ...
                         sint16              *predSampleArrayCr)
{
...
#if SIMD
  const static sint16 ALIGNED(16) filterSimd[8][2][8] =
  {
    {
      {  0,  64,   0,  64,   0,  64,   0,  64 },
      {  0,   0,   0,   0,   0,   0,   0,   0 }
  ...
  ptrRefCb = RefPicCb + ((sint32)Offset) + yInt*((sint32)RecPicWidth) + ((sint32)xInt);
  ptrRefCr = RefPicCr + ((sint32)Offset) + yInt*((sint32)RecPicWidth) + ((sint32)xInt);
