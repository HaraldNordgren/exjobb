...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    simimain = RunSimSHVC(simName              = "i_main_spatial1m5x_qpOff%d" % qpOff,             # need to have the looped variable in the name
                     encoderExe           = "../SHM-7.0/bin/TAppEncoderStatic",
                     decoderExe           = "../SHM-7.0/bin/TAppDecoderStatic",
                     extractorExe         = None,
                     cfgFileMain          = "../SHM-7.0/cfg/encoder_intra_main.cfg",
    ...
    # start simulations
    simimain.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simimain.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simimain.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simimain.confMain['NumAddLayerSets'] = 0
    simimain.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simimain.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simimain.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simimain.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    #added in SHM-7.0, needed for 1080p to 540p scalability, included in CC files 
    ...
    simimain2x.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simimain2x.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simimain2x.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simimain2x.confMain['NumAddLayerSets'] = 0
    simimain2x.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simimain2x.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simimain2x.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simimain2x.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    simramain = RunSimSHVC(simName              = "ra_main_spatial1m5x_qpOff%d" % qpOff,             # need to have the looped variable in the name
                     ...
                     decoderExe           = "../SHM-7.0/bin/TAppDecoderStatic",
                     extractorExe         = None,
                     cfgFileMain          = "../SHM-7.0/cfg/encoder_randomaccess_main.cfg",
                     cfgFileLayers        = ['cfg_shvc/layer0.cfg', 'cfg_shvc/layer1.cfg'], # Not used
                     testSet              = testSeqs.SHVC_SPATIAL_1m5X,
                     maxNumCodedFrames    = None,                                   # None: do nothing, N: restrict number of coded frames to N
                     temporalSubsampling  = None,                                   # None: do nothing, N: temporally subsample by N before coding
    ...
    # start simulations
    simramain.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simramain.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simramain.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simramain.confMain['NumAddLayerSets'] = 0
    simramain.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simramain.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simramain.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simramain.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    simramain2x.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simramain2x.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simramain2x.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simramain2x.confMain['NumAddLayerSets'] = 0
    simramain2x.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simramain2x.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simramain2x.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simramain2x.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
    ...
    simramain2x.confMain['Level'] = 4.1
    simramain2x.start()
...
for qpOff in qpOffsetSNR:
  ...
  for qpBL in qpSetBLSNR:
    ...
    # start simulations
    simramainsnr.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simramainsnr.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simramainsnr.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simramainsnr.confMain['NumAddLayerSets'] = 0
    simramainsnr.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simramainsnr.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simramainsnr.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simramainsnr.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
    ...
    simramainsnr.confMain['Level'] = 4.1
    simramainsnr.start()
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    simldPmain = RunSimSHVC(simName              = "ld_P_main_spatial1m5x_qpOff%d" % qpOff,             # need to have the looped variable in the name
                     ...
                     decoderExe           = "../SHM-7.0/bin/TAppDecoderStatic",
                     extractorExe         = None,
                     cfgFileMain          = "../SHM-7.0/cfg/encoder_lowdelay_P_main.cfg",
                     cfgFileLayers        = ['cfg_shvc/layer0.cfg', 'cfg_shvc/layer1.cfg'], # Not used
                     testSet              = testSeqs.SHVC_SPATIAL_1m5X,
                     maxNumCodedFrames    = None,                                   # None: do nothing, N: restrict number of coded frames to N
                     temporalSubsampling  = None,                                   # None: do nothing, N: temporally subsample by N before coding
    ...
    # start simulations
    # optional
    simldPmain.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simldPmain.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simldPmain.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simldPmain.confMain['NumAddLayerSets'] = 0
    simldPmain.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simldPmain.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simldPmain.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simldPmain.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    simldPmain2x.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simldPmain2x.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simldPmain2x.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simldPmain2x.confMain['NumAddLayerSets'] = 0
    simldPmain2x.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simldPmain2x.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simldPmain2x.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simldPmain2x.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
    ...
    simldPmain2x.confMain['Level'] = 4.1
    #simldPmain2x.start()
...
for qpOff in qpOffsetSNR:
  ...
  for qpBL in qpSetBLSNR:
    ...
    # start simulations
    # optional
    simldPmainsnr.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simldPmainsnr.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simldPmainsnr.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simldPmainsnr.confMain['NumAddLayerSets'] = 0
    simldPmainsnr.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simldPmainsnr.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simldPmainsnr.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simldPmainsnr.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
    ...
    simldPmainsnr.confMain['Level'] = 4.1
    #simldPmainsnr.start()
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    simldmain = RunSimSHVC(simName              = "ld_main_spatial1m5x_qpOff%d" % qpOff,             # need to have the looped variable in the name
                     ...
                     decoderExe           = "../SHM-7.0/bin/TAppDecoderStatic",
                     extractorExe         = None,
                     cfgFileMain          = "../SHM-7.0/cfg/encoder_lowdelay_main.cfg",
                     cfgFileLayers        = ['cfg_shvc/layer0.cfg', 'cfg_shvc/layer1.cfg'], # Not used
                     testSet              = testSeqs.SHVC_SPATIAL_1m5X,
                     maxNumCodedFrames    = None,                                   # None: do nothing, N: restrict number of coded frames to N
                     temporalSubsampling  = None,                                   # None: do nothing, N: temporally subsample by N before coding
    ...
    # start simulations
    simldmain.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simldmain.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simldmain.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simldmain.confMain['NumAddLayerSets'] = 0
    simldmain.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simldmain.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simldmain.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simldmain.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    simldmain2x.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simldmain2x.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simldmain2x.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simldmain2x.confMain['NumAddLayerSets'] = 0
    simldmain2x.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simldmain2x.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simldmain2x.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simldmain2x.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
    ...
    simldmain2x.confMain['Level'] = 4.1
    simldmain2x.start()
...
for qpOff in qpOffsetSNR:
  ...
  for qpBL in qpSetBLSNR:
    ...
    # start simulations
    simldmainsnr.confMain['NumLayerSets'] = 2 # Include default layer set, value of 0 not allowed, modified in 7.0
    simldmainsnr.confMain['NumLayerInIdList1'] = 2  # mod in 7.0
    simldmainsnr.confMain['LayerSetLayerIdList1'] = '0 1' # mod in 7.0
    simldmainsnr.confMain['NumAddLayerSets'] = 0
    simldmainsnr.confMain['NumOutputLayerSets'] = 2 # Include defualt OLS, value of 0 not allowed, new in 7.0
    simldmainsnr.confMain['DefaultTargetOutputLayerIdc'] = 1 # new in 7.0
    simldmainsnr.confMain['NumLayersInOutputLayerSet'] = 1 # The number of layers in the 0-th OLS should not be specified, new in 7.0
    simldmainsnr.confMain['ListOfOutputLayers1'] = 1 # new in 7.0, need not be specified
    ...
    simldmainsnr.confMain['Level'] = 4.1    
    simldmainsnr.start()
