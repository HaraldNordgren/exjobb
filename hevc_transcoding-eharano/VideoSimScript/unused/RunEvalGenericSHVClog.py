          ...
          while aline:
           ...
           if okfind==0:
             ...
             if(anchorScalable):
               ...
               bitrateEnc2 = float(alist[3])
               bitrateEnc2L0 = float(alist[3])
               psnrYEnc2L0 = float(alist[4])
               psnrUEnc2L0 = float(alist[5])
               psnrVEnc2L0 = float(alist[6])
             ...
             if(anchorScalable):
               ...
               bitrateEnc2L1 = float(alist[3])
               psnrYEnc2 = float(alist[4])
               psnrUEnc2 = float(alist[5])
               psnrVEnc2 = float(alist[6])
             else:  
