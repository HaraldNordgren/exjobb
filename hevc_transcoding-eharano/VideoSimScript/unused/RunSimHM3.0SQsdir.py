...
simra37 = RunSimSamsung(simName              = "all",
                                   encoderExe           = "../HM-3.0/bin/TAppEncoderStatic",
                                   decoderExe           = "../HM-3.0/bin/TAppDecoderStatic",
                                   cfgFileMain          = "../HM-3.0/cfg/encoder_randomaccess.cfg",
                                   testSet              = testSeqs.VCEGMPEG_CS1_CfP_SQsdir,
...
simra32 = RunSimSamsung(simName              = "all",
                                   encoderExe           = "../HM-3.0/bin/TAppEncoderStatic",
                                   decoderExe           = "../HM-3.0/bin/TAppDecoderStatic",
                                   cfgFileMain          = "../HM-3.0/cfg/encoder_randomaccess.cfg",
                                   testSet              = testSeqs.VCEGMPEG_CS1_CfP_SQsdir,
...
simld37 = RunSimSamsung(simName              = "all",
                                   encoderExe           = "../HM-3.0/bin/TAppEncoderStatic",
                                   decoderExe           = "../HM-3.0/bin/TAppDecoderStatic",
                                   cfgFileMain          = "../HM-3.0/cfg/encoder_lowdelay.cfg",
                                   testSet              = testSeqs.VCEGMPEG_CS2_CfP_SQVidyosdir,
                                   maxNumCodedFrames    = None,                                      # None: do nothing, N: restrict number of coded frames to N
                                   temporalSubsampling  = None,                                   # None: do nothing, N: temporally subsample by N before coding
                                   qpSet                = [[37], [32], [27], [22]],               # may be overriden by sequence specific configuration
                                   allowSeqOverride     = 1,
...
simld32 = RunSimSamsung(simName              = "all",
                                   encoderExe           = "../HM-3.0/bin/TAppEncoderStatic",
                                   decoderExe           = "../HM-3.0/bin/TAppDecoderStatic",
                                   cfgFileMain          = "../HM-3.0/cfg/encoder_lowdelay.cfg",
                                   testSet              = testSeqs.VCEGMPEG_CS2_CfP_SQVidyosdir,
...
simldloco37 = RunSimSamsung(simName              = "all",
                                   encoderExe           = "../HM-3.0/bin/TAppEncoderStatic",
                                   decoderExe           = "../HM-3.0/bin/TAppDecoderStatic",
                                   cfgFileMain          = "../HM-3.0/cfg/encoder_lowdelay_loco.cfg",
                                   testSet              = testSeqs.VCEGMPEG_CS2_CfP_SQsdir,
                                   maxNumCodedFrames    = None,                                      # None: do nothing, N: restrict number of coded frames to N
                                   temporalSubsampling  = None,                                   # None: do nothing, N: temporally subsample by N before coding
                                   qpSet                = [[37], [32], [27], [22]],               # may be overriden by sequence specific configuration
                                   allowSeqOverride     = 1,
...
simldloco32 = RunSimSamsung(simName              = "all",
                                   encoderExe           = "../HM-3.0/bin/TAppEncoderStatic",
                                   decoderExe           = "../HM-3.0/bin/TAppDecoderStatic",
                                   cfgFileMain          = "../HM-3.0/cfg/encoder_lowdelay_loco.cfg",
                                   testSet              = testSeqs.VCEGMPEG_CS2_CfP_SQsdir,
