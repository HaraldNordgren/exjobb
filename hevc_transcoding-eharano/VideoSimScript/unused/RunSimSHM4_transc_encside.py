...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    print "QPoff=%d\n" % (qpOff)
    qpSet = []
    #qpSet.append([qpBL+qpOff,qpBL])
    qpSet.append([qpBL,qpBL+qpOff])

    # configure simulation
    simimain = RunSimSHVC(simName              = "i_main_spatial1m5x_SIqpOff%d" % qpOff,             # need to have the looped variable in the name
                     encoderExe           = "../hevc_transcoding-eplkan/bin/TAppEncoderStatic_12tap_6b_singlam",
                     ...
                     jobParamsLsfOverride = ['intel', 'max15min', False])                 # only for LSF cluster: platform, queue, send results by email
    ...
    simimain.confMain['RDOQ1'] = 0 #0
    simimain.confMain['RDOQTS1'] = 0 #0
    simimain.confMain['SignHideFlag0'] = 1 
    simimain.confMain['SignHideFlag1'] = 1 #0 
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    # configure simulation
    simimain2x = RunSimSHVC(simName              = "i_main_spatial2x_SIqpOff%d" % qpOff,             # need to have the looped variable in the name
                     encoderExe           = "../hevc_transcoding-eplkan/bin/TAppEncoderStatic_12tap_6b_singlam",
                     decoderExe           = "../SHM-4.0/bin/TAppDecoderStatic",
                     extractorExe         = None,
                     cfgFileMain          = "../SHM-4.0/cfg/encoder_intra_main.cfg",
...
for qpOff in qpOffsetSNR:
  ...
  for qpBL in qpSetBLSNR:
    ...
    # configure simulation
    simimainsnr = RunSimSHVC(simName              = "i_main_snr_SIqpOff%d" % qpOff,             # need to have the looped variable in the name
                     encoderExe           = "../hevc_transcoding-eplkan/bin/TAppEncoderStatic_12tap_6b_singlam",
                     decoderExe           = "../SHM-4.0/bin/TAppDecoderStatic",
                     extractorExe         = None,
                     cfgFileMain          = "../SHM-4.0/cfg/encoder_intra_main.cfg",
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    # configure simulation
    simramain = RunSimSHVC(simName              = "ra_main_spatial1m5x_SIqpOff%d" % qpOff,             # need to have the looped variable in the name
                     encoderExe           = "../hevc_transcoding-eplkan/bin/TAppEncoderStatic_12tap_6b_singlam",
                     decoderExe           = "../SHM-4.0/bin/TAppDecoderStatic",
                     extractorExe         = None,
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    # configure simulation
    simramain2x = RunSimSHVC(simName              = "ra_main_spatial2x_SIqpOff%d_2" % qpOff,             # need to have the looped variable in the name
                     encoderExe           = "../hevc_transcoding-eplkan/bin/TAppEncoderStatic_12tap_6b_singlam",
                     decoderExe           = "../SHM-4.0/bin/TAppDecoderStatic",
                     extractorExe         = None,
                     cfgFileMain          = "../SHM-4.0/cfg/encoder_randomaccess_main.cfg",
...
for qpOff in qpOffset:
  ...
  for qpBL in qpSetBL:
    ...
    # configure simulation
    simramain3x = RunSimSHVC(simName              = "ra_main_spatial3x_SIqpOff%d" % qpOff,             # need to have the looped variable in the name
                     encoderExe           = "../hevc_transcoding-eplkan/bin/TAppEncoderStatic_12tap_6b_singlam",
                     decoderExe           = "../SHM-4.0/bin/TAppDecoderStatic",
                     extractorExe         = None,
                     cfgFileMain          = "../SHM-4.0/cfg/encoder_randomaccess_main.cfg",
                     cfgFileLayers        = ['cfg_shvc/layer0.cfg', 'cfg_shvc/layer1.cfg'], # Not used
                     testSet              = testSeqs.SHVC_SPATIAL_3X_HD_TRN, #SHVC_SPATIAL_2X_HD_TRN,
                     maxNumCodedFrames    = None,                                   # None: do nothing, N: restrict number of coded frames to N
                     temporalSubsampling  = None,                                   # None: do nothing, N: temporally subsample by N before coding
                     qpSet                = qpSet,                                  # may be overriden by sequence specific configuration
                     allowSeqOverride     = 1,
...
for qpOff in qpOffsetSNR:
  ...
  for qpBL in qpSetBLSNR:
    ...
    # configure simulation
    simramainsnr = RunSimSHVC(simName              = "ra_main_snr_SIqpOff%d" % qpOff,             # need to have the looped variable in the name
                     encoderExe           = "../hevc_transcoding-eplkan/bin/TAppEncoderStatic_12tap_6b_singlam",
                     decoderExe           = "../SHM-4.0/bin/TAppDecoderStatic",
                     extractorExe         = None,
                     cfgFileMain          = "../SHM-4.0/cfg/encoder_randomaccess_main.cfg",
