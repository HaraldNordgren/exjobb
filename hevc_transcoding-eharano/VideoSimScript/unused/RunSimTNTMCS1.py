...
sim = RunSimTNTM(simName              = "tntmI7B",
                 encoderExe           = "bin/tntmenc.exe",
                 decoderExe           = "bin/tntmdec.exe",
                 cfgFileMain          = "cfg_tntm/configTNTM_I7BPMPEGcfpclean.txt",
                 # cfgFileMain          = "cfg_tntm/configTNTM_I7BPMPEGcfp.txt",
                 # configTNTM_I7BPMPEGcfp works on versions before clean up of TENTM  
                 ...
                 allowSeqOverride     = 1,
                 cfgSeqDirOverride    = "cfg_tntm/cfg_seq_CS1_5qpnew",
