...
sim = RunSimSamsung(simName              = "HEVC_vs_AVC_TMuC09",
               encoderExe           = "../bin/HM10/TAppEncoderStatic",
               decoderExe           = "../bin/HM10/TAppDecoderStatic",
               cfgFileMain          = "cfg_hevc_4_6_8_10_mbps/encoder_randomaccess.cfg",
               testSet              = testSeqs.RSM_720p50_HEVC_vs_AVC,
               ...
               qpSet                = [[25],[26], [27], [28]],               # may be overriden by sequence specific configuration
               allowSeqOverride     = 1,
               cfgSeqDirOverride    = "cfg_hevc_4_6_8_10_mbps/cfg_seq_HEVC_vs_AVC",
...
#               jobParamsLsfOverride = ['linux', 'max30min', True])           # only for LSF cluster: platform, queue, send results by email
#               jobParamsLsfOverride = ['linux', 'sim_24h', True])            # only for LSF cluster: platform, queue, send results by email
...
sim.confMain['IntraPeriod'] = 64
sim.confMain['GOPSize'] = 4
sim.confMain['RateGOPSize'] = 4
